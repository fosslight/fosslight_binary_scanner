...
1. <a class="github-button" href="https://github.com/fosslight/fosslight_binary/fork" data-icon="octicon-repo-forked" aria-label="Fork fosslight/fosslight_binary on GitHub">```Fork```</a> and clone the repository
